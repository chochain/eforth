...
.( you can add many different currency bills then all up in dollars: ) cr
.( 1000 nt 500 hk + .s => ) 1000 nt 500 hk + .s cr
.( 320 rmb + .s => )        320 rmb + .s cr
.( print out total worth in dollars => ) dollars cr
